...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-10.0f, 1.0f, 2.0f);
	...
	//SetShaderColor(1,0.502, 0.000,0.502);
	SetShaderTexture("housewall");
	SetTextureUVScale(1.0, 1.0);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.0f, 5.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 2.0f, -1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.5f, 4.5f, 0.0f);
	...
	//SetShaderColor(1, 0.902, 0.902, 0.980);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(-2.0f,8.0f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.5f, 2.5f, 0.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 4.0f, -1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.5f, 7.0f, -1.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(5.0f, 8.0f, 1.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(-2.0f, 9.0f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.5f, 3.0f, 2.0f);
	...
	//second floor shade on 3rd block
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(6.0f, 2.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f,7.5f, 0.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.0f, 7.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 3.5f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.5f, 8.5f, -1.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f, 3.5f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f, 6.5f, -1.5f);
